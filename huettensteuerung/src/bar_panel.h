...
void loop() {
  Huette::bar_controller::VI4_BTN_KL.handle(getByte(0x01));
  Huette::bar_controller::VI6_BTN_DMX.handle(getByte(0x02));
}
...
void setLeds() {
  ...
  // Scene 1
  color = 0;
  if (Huette::bar_controller::VI1_BTN_S1.isPressed()) color = 0x00FFFFFF;
  Wire.write(color);
  Wire.write(color);

  // Scene 2
  color = 0;
  if (Huette::bar_controller::VI2_BTN_S2.isPressed()) color = 0x00FFFFFF;
  Wire.write(color);
  Wire.write(color);

  // Scene 3
  color = 0;
  if (Huette::bar_controller::VI3_BTN_S3.isPressed()) color = 0x00FFFFFF;
  Wire.write(color);
  Wire.write(color);

  // Kronleuchter
  color = getLEDcolor(Huette::K1_KL1_A.getState());
  if (Huette::bar_controller::VI4_BTN_KL.isPressed()) color = 0x00FFFFFF;
  Wire.write(color);
  ...
  if (Huette::bar_controller::VI5_BTN_BL.isPressed()) color = 0x00FFFFFF;
  Wire.write(color);
  ...
  if (Huette::bar_controller::VI6_BTN_DMX.isPressed()) color = 0x00FFFFFF;
  Wire.write(color);
  Wire.write(color);
